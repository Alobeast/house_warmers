...
# Flats
flat1 = Flat.create!(address:'Korte Bergstraat 2B, Amersfoort', bedrooms:1, size:42, build_year:1985, price_cents:100000, description:
  ...
  Amersfoort train station.', rental_price:900, landlord:laura, tenant:killian, bathrooms:1, letting_status:"pending", available: true,
...
flat2 = Flat.create!(address:'Korte Prinsengracht 24, Amsterdam',
  bedrooms:2, size:85, build_year:1964, price_cents:180000, description:
  ...
  close by.', rental_price:1900, landlord:marc, tenant:filippo, bathrooms:1, letting_status:"pending", available: true,
...
flat3 = Flat.create!(address:'Baarsjesweg 192B, Amsterdam',
  bedrooms:2, size:82, build_year:1958, price_cents:200000, description:
  ...
  his and her basins. 5min walk to the metro.', rental_price:1950, landlord:alois, tenant:amir, bathrooms:2, letting_status:"pending", available: true,
...
flat4 = Flat.create!(address:'Sarphatipark 34, Amsterdam',
  bedrooms:2, size:122, build_year:1975, price_cents:240000, description:
  ...
  a 3 min walk to the metro. The apartment is furnished and available immediately', rental_price:2400, landlord:catherine, available: true,
...
flat5 = Flat.create!(address:'Tuinstraat 11, Amsterdam',
  bedrooms:2, size:102, build_year:1975, price_cents:250000, description:
  'Jordaan apartment close to the nine streets and the famous canals. This is a two bedroom one
  bathroom apartment with a modern finish.', rental_price:2600, landlord:shivani, tenant:carmen, bathrooms:2, letting_status:"pending", available: true,
...
flat6 = Flat.create!(address:'Daniël Stalpertstraat 14, Amsterdam',
  bedrooms:1, size:48, build_year:1972, price_cents:180000, description:
...
flat7 = Flat.create!(address:'Den Texstraat 8, Amsterdam',
  bedrooms:2, size:88, build_year:1975, price_cents:240000, description:
...
flat8 = Flat.create!(address:'Elisabeth Wolffstraat 10, Amsterdam',
  bedrooms:2, size:122, build_year:1935, price_cents:220000, description:
  'Recently renovated 2 bedroom apartment in the heart of Oud West. The apartment
  was renovated in 2017 and boasts a modern and sleek finish. Plenty of
  storage and 2 large bedrooms. The bathroom has a large rain shower and separate
  his and her basins. 5min walk to the metro.', rental_price:2400, landlord:daniel, tenant:anthony, bathrooms:2, letting_status:"pending", available: true,
...
flat9 = Flat.create!(address:'Wilhelminastraat 22, Amsterdam',
  bedrooms:2, size:92, build_year:1982, price_cents:200000, description:
...
flat10 = Flat.create!(address:'Kerkstraat 322, Amsterdam',
  bedrooms:2, size:108, build_year:1960, price_cents:210000, description:
...
review2 = Review.create!(rating:2, comment:'Huge damp problem in the flat. Constant wet smell', flat:flat2, tenant:david, area_rating: 4, noise_rating: 4, condition_rating: 2, energy_rating: 2, landlord_rating: 2, plumbing_rating: 2)
...
review8 = Review.create!(rating:4, comment:'Huge damp problem in the flat.', flat:flat3, tenant:anthony,  area_rating: 4, noise_rating: 4, condition_rating: 2, energy_rating: 3, landlord_rating: 2, plumbing_rating: 1)
